...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.PUT("/users/:user/like/:photoid", rt.wrap(rt.Photolike))
	rt.router.DELETE("/users/:user/unlike/:photoid", rt.wrap(rt.Photounlike))
	...
	rt.router.DELETE("/users/:user/follow/:targetuser", rt.wrap(rt.Unfollowuser))
	rt.router.PUT("/users/:user/ban/:targetuser", rt.wrap(rt.Ban))
	rt.router.DELETE("/users/:user/ban/:targetuser", rt.wrap(rt.Unban))
