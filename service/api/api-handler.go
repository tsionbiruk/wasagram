...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.DELETE("/users/:user/likes/:photoid", rt.wrap(rt.Photounlike))
	...
	rt.router.PUT("/users/:user/followed/:targetuser", rt.wrap(rt.Followuser))
	rt.router.DELETE("/users/:user/followed/:targetuser", rt.wrap(rt.Unfollowuser))
	rt.router.GET("/users/:user/followers", rt.wrap(rt.GetFollowers))
	rt.router.GET("/users/:user/following", rt.wrap(rt.Getfollowing))
	rt.router.PUT("/users/:user/banned/:targetuser", rt.wrap(rt.Ban))
	rt.router.DELETE("/users/:user/banned/:targetuser", rt.wrap(rt.Unban))
